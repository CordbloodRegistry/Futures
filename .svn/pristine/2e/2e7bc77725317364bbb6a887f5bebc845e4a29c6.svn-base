//
//  cbrLoadFacilityStatOperation.m
//  fieldMobile
//
...
#import "cbrLoadFacilityStatOperation.h"
#import "cbrAppDelegate.h"

@implementation cbrLoadFacilityStatOperation
@synthesize done;
@synthesize status;
@synthesize errorMsg;
...
-(void) main
{
    ...
    NSString *filename = [filenamePath stringByAppendingString:@"/facilityStats.json"];
